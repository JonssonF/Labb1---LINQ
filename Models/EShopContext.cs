    ...
    public class EShopContext : DbContext
    {
        ...
        public static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>().HasData(
                ...
                new Order { Id = 2, OrderDate = new DateTime(2025, 3, 5), CustomerId = 2, TotalAmount = 9595, Status = OrderStatus.Delivered },
                ...
                new Order { Id = 5, OrderDate = new DateTime(2025, 3, 15), CustomerId = 5, TotalAmount = 17494, Status = OrderStatus.Shipped },
                new Order { Id = 6, OrderDate = new DateTime(2025, 2, 20), CustomerId = 1, TotalAmount = 899, Status = OrderStatus.Delivered },
                new Order { Id = 7, OrderDate = new DateTime(2025, 2, 25), CustomerId = 3, TotalAmount = 2546, Status = OrderStatus.Delivered },
            ...
            modelBuilder.Entity<OrderDetail>().HasData(
                ...
                new OrderDetail { Id = 3, OrderId = 2, ProductId = 13, Quantity = 1, UnitPrice = 899 },
                ...
                new OrderDetail { Id = 11, OrderId = 8, ProductId = 15, Quantity = 2, UnitPrice = 499 },
                new OrderDetail { Id = 12, OrderId = 9, ProductId = 5, Quantity = 1, UnitPrice = 4995 },
                new OrderDetail { Id = 13, OrderId = 9, ProductId = 14, Quantity = 1, UnitPrice = 799 },
                new OrderDetail { Id = 14, OrderId = 10, ProductId = 6, Quantity = 1, UnitPrice = 1299 }
            );
        }
