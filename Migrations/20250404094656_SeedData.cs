...
namespace Labb1___LINQ.Migrations
{
    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "Id", "ContactPerson", "Email", "Name", "Phone", "SupplierId" },
                values: new object[,]
                {
                    { 1, "Anna Lindberg", "anna@techvision.se", "TechVision AB", "070-123-4567", null },
                    { 2, "Johan Bergman", "johan@homestyle.se", "HomeStyle", "073-234-5678", null },
                    { 3, "Maria Ek", "maria@fashionfirst.se", "Fashion First", "076-345-6789", null },
                    { 4, "Erik Strand", "erik@sportmax.se", "SportMax", "072-456-7890", null },
                    { 5, "Karl Holm", "karl@nordicelec.se", "Nordic Electronics", "070-567-8901", null },
                    { 6, "Lisa Björk", "lisa@globalgadgets.se", "Global Gadgets", "073-678-9012", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 11999 },
                    { 2, 2, new DateTime(2025, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 9798 },
                    { 3, 3, new DateTime(2025, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, 18999 },
                    { 4, 4, new DateTime(2025, 3, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 3499 },
                    { 5, 5, new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 16994 },
                    { 6, 1, new DateTime(2025, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 899 },
                    { 7, 3, new DateTime(2025, 2, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2498 },
                    { 8, 2, new DateTime(2025, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1598 },
                    { 9, 4, new DateTime(2025, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, 5794 },
                    { 10, 5, new DateTime(2025, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, 1299 }
                });
